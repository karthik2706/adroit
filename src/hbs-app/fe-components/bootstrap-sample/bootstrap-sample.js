...
// dependencies
import './bootstrap-sample.hbs';
import './bootstrap-sample.scss';
 ...
 * @type {string}
 */
export const componentReference = 'app-js__bootstrap-sample';

/**
 * The style definition of the component.
 * @type {string}
 */
export const styleDefinition = 'bootstrap-sample';
...
registerComponent(componentReference, createBootstrapsampleInstance);
